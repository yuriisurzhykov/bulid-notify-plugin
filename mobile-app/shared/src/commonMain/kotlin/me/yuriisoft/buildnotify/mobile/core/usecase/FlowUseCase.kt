 ...
 * ) : FlowUseCase<ObserveBuildEventsUseCase.Params, WsEnvelope>() {
 *
 *     data class Params(val host: String, val port: Int)
 *
 *     override fun invoke(params: Params): Flow<WsEnvelope> =
